...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAdminAffiliationRequestsAffiliationRequestsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AffiliationRequestsComponent, [{
        ...
        key: "deleteRequest",
        value: function deleteRequest(personData) {
          var _this3 = this;
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              _this3._toastr.success('Request Deleted Successfully.');
            }
          });
        }
      }]);
  ...
  function srcAppAdminEnquiriesEnquiriesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function EnquiriesComponent(_service, _spinner) {
      ...
      _createClass(AffliationComponent, [{
        ...
        value: function getRegisteredDistrictList() {
          ...
          this._service.getRegisteredDistricts().subscribe(function (data) {
            data.map(function (item, index) {
              _this6.registeredDistrictsList.push(item.payload.doc.data());

              if (index === 0) {
                _this6.getDistrictInfo(_this6.registeredDistrictsList[0].id);
              }
            });
        ...
        value: function getDistrictInfo(id) {
          ...
          this._service.getRegisteredDistrictInfoById(id).subscribe(function (config) {
            _this7.selectedDistrict = [];
            config.map(function (data, index) {
              _this7.selectedDistrict.push(data.payload.doc.data());

              if (index === 0) {
                _this7.districtInfo = {
                  districtName: _this7.selectedDistrict[0].requestedDistrict.name,
                  approvedOn: _this7.selectedDistrict[0].approvedOn
                };
              }
            });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_6__["HomeComponent"], _layout_footer_footer_component__WEBPACK_IMPORTED_MODULE_7__["FooterComponent"], _layout_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_8__["NavbarComponent"], _affliation_affliation_component__WEBPACK_IMPORTED_MODULE_12__["AffliationComponent"], _contact_us_contact_us_component__WEBPACK_IMPORTED_MODULE_13__["ContactUsComponent"], _slingshot_slingshot_component__WEBPACK_IMPORTED_MODULE_15__["SlingshotComponent"], _gallery_gallery_component__WEBPACK_IMPORTED_MODULE_16__["GalleryComponent"], _association_association_component__WEBPACK_IMPORTED_MODULE_17__["AssociationComponent"], _match_results_match_results_component__WEBPACK_IMPORTED_MODULE_18__["MatchResultsComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_20__["LoginComponent"], _admin_affiliation_requests_affiliation_requests_component__WEBPACK_IMPORTED_MODULE_25__["DistrictApprovalDialog"], _admin_admin_component__WEBPACK_IMPORTED_MODULE_24__["AdminComponent"], _admin_affiliation_requests_affiliation_requests_component__WEBPACK_IMPORTED_MODULE_25__["AffiliationRequestsComponent"], _admin_events_events_component__WEBPACK_IMPORTED_MODULE_26__["EventsComponent"], _admin_enquiries_enquiries_component__WEBPACK_IMPORTED_MODULE_27__["EnquiriesComponent"], _admin_match_event_results_match_event_results_component__WEBPACK_IMPORTED_MODULE_28__["MatchEventResultsComponent"], _admin_profile_profile_component__WEBPACK_IMPORTED_MODULE_29__["ProfileComponent"], _shared_dialogs_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_39__["ConfirmDialogComponent"]],
      imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_21__["FormsModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_21__["ReactiveFormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_9__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["environment"].firebaseConfig), _angular_fire_auth__WEBPACK_IMPORTED_MODULE_30__["AngularFireAuthModule"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_10__["AngularFirestoreModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_14__["MatTooltipModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_19__["MatInputModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_22__["MatCheckboxModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_23__["MatDialogModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_31__["ToastrModule"].forRoot(), _angular_material_table__WEBPACK_IMPORTED_MODULE_32__["MatTableModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_33__["MatPaginatorModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_34__["MatSortModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_35__["MatIconModule"], ngx_spinner__WEBPACK_IMPORTED_MODULE_36__["NgxSpinnerModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_37__["MatButtonModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_38__["MatDatepickerModule"]],
                  ...
                  case 0:
                    ...
                    return this.slingshotService.getAvailabelDistricts().subscribe(function (data) {
                      data.map(function (item) {
                        _this8.availableDistricts.push(item.payload.doc.data());
                      });

                      _this8._spinner.hide();
  ...
  function srcAppContactUsContactUsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ContactUsComponent(formBuilder, _service) {
      ...
      _createClass(AuthService, [{
        ...
        value: function signUp(data) {
          ...
          return this.afAuth.auth.createUserWithEmailAndPassword(data.email, data.password).then(function (result) {
            ...
            _this11.firestore.collection("AffiliationRequests").doc(result.user.uid).set(Object.assign({
              role: 'President'
            }, data));

            var dialogRef = _this11.dialog.open(_dialogs_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmDialogComponent"], {
              data: {
                message: 'Do you want to approve user?',
                type: 'register'
              },
            ...
            dialogRef.afterClosed().subscribe(function (result) {
              if (result) {
                _this11.router.navigateByUrl('/login');
              }
            });
          }).catch(function (error) {
            if (error.code === 'auth/email-already-in-use') {
              _this11.toastr.error('Email address already in used.');
            } else {
                    ...
                    return this.afAuth.auth.signInWithEmailAndPassword(email, password).then(function (result) {
                      ...
                      switch (error.code) {
                        case 'auth/user-not-found':
                          _this12.toastr.error('User Not Found');

                          break;

                        case 'auth/wrong-password':
                          _this12.toastr.error('Wrong Password');
        ...
        value: function approveDistrict(data) {
          ...
          this.firestore.doc('ApprovedDistricts/' + data.requestedDistrict.id).collection('Members').get().subscribe(function (config) {
            ...
            if (config.size === 0) {
              ...
              _this13.firestore.collection('ApprovedDistricts').doc(data.requestedDistrict.id).collection('Members').doc(data.id).set(data); // Update isRegister flag in district list


              _this13.firestore.collection('DistrictList').doc(data.requestedDistrict.id).update({
                isRegistered: true
              }); // Delete user data from RegistrationRequests collection


              _this13.firestore.collection('AffiliationRequests').doc(data.id).delete();

              _this13._toastr.success("District Approved Successfully.");
            } else {
              _this13._toastr.error("District is already allocated.");
            }
          });
        }
      }, {
