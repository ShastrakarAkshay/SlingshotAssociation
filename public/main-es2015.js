...
let AdminComponent = class AdminComponent {
    ...
    ngOnInit() {
        ...
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(e => e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationStart"])).subscribe(e => {
            this.setActiveClassFromURL(this.router.url);
        });
    }
    setActiveClassFromURL(url) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddMemberDialog", function() { return AddMemberDialog; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
    ...
    getAffiliationRequestData() {
        ...
        this._service.getAffiliationRequests().subscribe(data => {
            this.affiliatinRequests = data.map((item, index) => {
                return Object.assign({ id: item.payload.doc.id }, item.payload.doc.data(), { index: index + 1 });
            });
...
let AddMemberDialog = class AddMemberDialog {
    constructor(_dialogRef, _service, _toastr, formBuilder, utility, data) {
        this._dialogRef = _dialogRef;
        this._service = _service;
        this._toastr = _toastr;
    ...
    addMemberData() {
        ...
        let members = this.personData.members;
...
AddMemberDialog.ctorParameters = () => [
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogRef"] },
    { type: src_app_shared_services_slingshot_service__WEBPACK_IMPORTED_MODULE_5__["SlingshotService"] },
    { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_8__["ToastrService"] },
...
AddMemberDialog = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'add-member-dialog',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./dialogs/add-member.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/affiliation-requests/dialogs/add-member.html")).default
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](5, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MAT_DIALOG_DATA"]))
], AddMemberDialog);
    ...
    ngOnInit() {
        ...
        this._service.getAllRefrees().subscribe(data => {
            this.refreeData = data.map((item, index) => {
                return Object.assign({ id: item.payload.doc.id, name: item.payload.doc.data().firstName + ' ' + item.payload.doc.data().middleName + ' ' + item.payload.doc.data().lastName }, item.payload.doc.data(), { index: index + 1 });
            });
...
let AffliationComponent = class AffliationComponent {
    ...
    getRegisteredDistrictList() {
        ...
        this._service.getRegisteredDistricts().subscribe(data => {
            data.map((item, index) => {
                this.registeredDistrictsList.push(Object.assign({}, item.payload.doc.data(), { isActive: false }));
                if (index === 0) {
...
const APP_DIALOGS = [
    ...
    _admin_affiliation_requests_affiliation_requests_component__WEBPACK_IMPORTED_MODULE_25__["AddMemberDialog"],
    //child components
...
let AssociationComponent = class AssociationComponent {
    constructor(slingshotService, firestore, formBuilder, auth, afStorage, firebase, dialog, router, utility, _spinner) {
    ...
    uploadAdhaar(event) {
        ...
        task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["last"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["switchMap"])(() => fileRef.getDownloadURL())).subscribe(url => {
...
AssociationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](4, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_fire_storage__WEBPACK_IMPORTED_MODULE_10__["AngularFireStorage"]))
