...
let EnquiriesComponent = class EnquiriesComponent {
    constructor(_service, _spinner, _dialog) {
        this._service = _service;
        this._spinner = _spinner;
        this._dialog = _dialog;
        this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"]();
...
let CreateEventDialog = class CreateEventDialog {
    constructor(_dialogRef, _service, formBuilder, data) {
        this._dialogRef = _dialogRef;
        this._service = _service;
    ...
    ngOnInit() {
        ...
        this._service.getAllRefrees().subscribe(data => {
            this.refreeData = data.map(item => {
                return Object.assign({ id: item.payload.doc.id, name: item.payload.doc.data().firstName + ' ' + item.payload.doc.data().middleName + ' ' + item.payload.doc.data().lastName }, item.payload.doc.data());
            });
...
/* harmony import */ var _admin_refree_panel_refree_panel_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./admin/refree-panel/refree-panel.component */ "./src/app/admin/refree-panel/refree-panel.component.ts");
/* harmony import */ var _committee_committee_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./committee/committee.component */ "./src/app/committee/committee.component.ts");
...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'refree', component: _admin_refree_panel_refree_panel_component__WEBPACK_IMPORTED_MODULE_19__["RefreePanelComponent"] }
        ]
    },
    {
        path: '**',
...
/* harmony import */ var _referee_referee_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./referee/referee.component */ "./src/app/referee/referee.component.ts");
/* harmony import */ var _admin_refree_panel_refree_panel_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./admin/refree-panel/refree-panel.component */ "./src/app/admin/refree-panel/refree-panel.component.ts");
/* harmony import */ var _shared_components_spinner_spinner_component__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./shared/components/spinner/spinner.component */ "./src/app/shared/components/spinner/spinner.component.ts");
/* harmony import */ var _committee_committee_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./committee/committee.component */ "./src/app/committee/committee.component.ts");
...
const APP_DIALOGS = [
    ...
    _admin_refree_panel_refree_panel_component__WEBPACK_IMPORTED_MODULE_41__["AddRefreeDialog"]
];
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _referee_referee_component__WEBPACK_IMPORTED_MODULE_40__["RefereeComponent"],
            _admin_refree_panel_refree_panel_component__WEBPACK_IMPORTED_MODULE_41__["RefreePanelComponent"],
            ...APP_DIALOGS,
            _shared_components_spinner_spinner_component__WEBPACK_IMPORTED_MODULE_42__["SpinnerComponent"],
            _committee_committee_component__WEBPACK_IMPORTED_MODULE_43__["CommitteeComponent"]
        ],
        imports: [
...
let ContactUsComponent = class ContactUsComponent {
    constructor(formBuilder, _service, dataService) {
        this.formBuilder = formBuilder;
        this._service = _service;
...
let HomeComponent = class HomeComponent {
    constructor(_service, _dataService) {
        this._service = _service;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RefereeComponent", function() { return RefereeComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let RefereeComponent = class RefereeComponent {
    constructor() {
...
RefereeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-referee',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./referee.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/referee/referee.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./referee.component.scss */ "./src/app/referee/referee.component.scss")).default]
    })
], RefereeComponent);
